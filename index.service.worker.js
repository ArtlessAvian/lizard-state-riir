...
/** @type {string} */
const CACHE_VERSION = '1755817762|5132501';
/** @type {string} */
const CACHE_PREFIX = 'Lizard State 2-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","godot_glue.wasm"];
